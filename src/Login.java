...
import resource.implement.AuthImplement;
...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField1.setSelectionColor(new java.awt.Color(71, 141, 241));
        ...
        jPasswordField1.setSelectionColor(new java.awt.Color(71, 141, 241));
        ...
        loginBtn.setBackground(new java.awt.Color(71, 141, 241));
    ...
    private void loginBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginBtnActionPerformed
        ...
        try {
            ...
            if(status) {
                ...
                Dashboard anotherFrame = new Dashboard();
                anotherFrame.setVisible(true);
            } else {
                 JOptionPane.showMessageDialog(this, "Login Gagal, Pastikan Username dan Password Benar");
            }
        } catch (Exception e) {
